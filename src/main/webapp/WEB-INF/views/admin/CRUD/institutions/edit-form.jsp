...
<header class="header--main-page">
    ...
    <div class="slogan container container--90">
        ...
        <div class="form-section--column">
            <div>
            <label> Id <input type="number" name="id" value="${institution.id}" readonly/> </label>
            </div>
            <div>
            <label> Nazwa <input type="text" name="name" value="${institution.name}" /> </label>
            </div>
            <div>
            <label> Opis <input type="text" name="description" value="${institution.description}" /> </label>
            </div>
            <div>
            <label> Status
            <select name="active">
                <option value="true">Aktywna</option>
                <option value="false" ${!institution.active ? 'selected' : ''}>Nieaktywna</option>
            </select>
            </label>
            </div>
