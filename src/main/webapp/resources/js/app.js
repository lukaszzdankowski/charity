...
//   form confirmation:
    ...
    confirmationButton.addEventListener("click", function (event) {
        ...
        foundation.innerText = "Dla fundacji " + select.getAttribute("data-institution");

        //address
        address.children[0].innerText = data.get("street");
        address.children[1].innerText = data.get("city");
        address.children[2].innerText = data.get("zipCode");

        //term
        term.children[0].innerText = data.get("pickUpDate");
        term.children[1].innerText = data.get("pickUpTime");
        term.children[2].innerText = data.get("pickUpComment");
